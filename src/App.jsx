      ...
      {avatarMenuOpen && (
        ...
        >
          ...
          <button
            ...
            style={{ width: "100%", marginTop: 8, padding: "7px", background: "#fef2f2", color: "#dc2626", border: "1px solid #fecaca", borderRadius: 6, fontSize: 10, fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", justifyCenter: "center", gap: 6 }}
          >
